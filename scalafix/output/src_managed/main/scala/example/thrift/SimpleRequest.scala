...
object SimpleRequest extends ValidatingThriftStructCodec3[SimpleRequest] with StructBuilderFactory[SimpleRequest] {
  ...
  private[this] val structFields: Seq[ThriftStructField[SimpleRequest]] = Seq[ThriftStructField[SimpleRequest]](
    new ThriftStructField[SimpleRequest](
      IdField,
      _root_.scala.Some(IdFieldManifest),
      classOf[SimpleRequest]) {
        def getValue[R](struct: SimpleRequest): R = struct.id.asInstanceOf[R]
    }
  )

  override lazy val metaData: ThriftStructMetaData[SimpleRequest] =
    ThriftStructMetaData(this, structFields, fieldInfos, Nil, structAnnotations)

  /**
   * Checks that all required fields are non-null.
   */
  def validate(_item: SimpleRequest): Unit = {
   ...
   */
  def validateNewInstance(item: SimpleRequest): scala.Seq[com.twitter.scrooge.validation.Issue] = {
  ...
  def withoutPassthroughFields(original: SimpleRequest): SimpleRequest =
    new Immutable(
      id = original.id
    )

  lazy val unsafeEmpty: SimpleRequest = {
    val id: String = "empty"
  ...
  def newBuilder(): StructBuilder[SimpleRequest] = new SimpleRequestStructBuilder(_root_.scala.None, fieldTypes)

  override def encode(_item: SimpleRequest, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }


  override def decode(_iprot: TProtocol): SimpleRequest = {
  ...
  private[thrift] def eagerDecode(_iprot: TProtocol): SimpleRequest = {
    decodeInternal(_iprot, false)
  }

  private[this] def decodeInternal(_iprot: TProtocol, lazily: Boolean): SimpleRequest = {
    var idOffset: Int = -1
    var id: String = null
    var _got_id = false
    ...
    if (!_got_id) _root_.com.twitter.scrooge.internal.TProtocols.throwMissingRequiredField("SimpleRequest", "id")
  ...
  def unapply(_item: SimpleRequest): _root_.scala.Option[String] = _root_.scala.Some(_item.id)



  object Immutable extends ThriftStructCodec3[SimpleRequest] {
    override def encode(_item: SimpleRequest, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): SimpleRequest = SimpleRequest.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[SimpleRequest] = SimpleRequest.metaData
  }

  /**
   * The default read-only implementation of SimpleRequest.  You typically should not need to
   * directly reference this class; instead, use the SimpleRequest.apply method to construct
   * new instances.
   */
  class Immutable(
      val id: String,
...
/**
 * Prefer the companion object's [[example.thrift.SimpleRequest.apply]]
 * for construction if you don't need to specify passthrough fields.
 */
trait SimpleRequest
  extends ThriftStruct
  with _root_.scala.Product1[String]
  with ValidatingThriftStruct[SimpleRequest]
  with java.io.Serializable
{
  import SimpleRequest._
      ...
      val _fieldOpt: _root_.scala.Option[TField] = _fieldId match {
        case 1 =>
          if (id ne null) {
            ...
            _root_.scala.Some(SimpleRequest.IdField)
          } else {
            _root_.scala.None
          }
   ...
   */
  def unsetField(_fieldId: Short): SimpleRequest = {
    var id: String = this.id
   ...
   * from the passthroughFields map, if present.
   */
  def unsetId: SimpleRequest = unsetField(1)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[SimpleRequest]

  private[this] def _equals(other: SimpleRequest): Boolean =
  ...
  override def equals(other: Any): Boolean =
    canEqual(other) && _equals(other.asInstanceOf[SimpleRequest])
  ...
  override def productPrefix: String = "SimpleRequest"

  def _codec: ValidatingThriftStructCodec3[SimpleRequest] = SimpleRequest

  def newBuilder(): StructBuilder[SimpleRequest] = new SimpleRequestStructBuilder(_root_.scala.Some(this), fieldTypes)
}

private[thrift] class SimpleRequestStructBuilder(instance: _root_.scala.Option[SimpleRequest], fieldTypes: IndexedSeq[ClassTag[_]])
    extends StructBuilder[SimpleRequest](fieldTypes) {

  def build(): SimpleRequest = {
    ...
    if (instance.isDefined) {
      ...
      if (genericArrayOps(_fieldArray).contains(null)) throw new InvalidFieldsException(structBuildError("SimpleRequest"))
      SimpleRequest(
